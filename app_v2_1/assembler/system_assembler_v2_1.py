...
from app_v2_1.assembler.validators_v2_1 import (
    validate_instances_package,
    validate_mqtt_config,
    validate_system_config,
)
from app_v2_1.loaders.config_loaders import load_yaml_config
from app_v2_1.models import SystemAssembly


class SystemAssemblerV2_1:
    ...
    def assemble(self) -> SystemAssembly:
        ...
        system_config = validate_system_config(raw_system, self.log_mode)

        raw_instances = load_yaml_config(
            base_path=self.base_path,
            file_path=system_config.instances_package,
            log_mode=self.log_mode,
        ...
        raw_mqtt = load_yaml_config(
            base_path=self.base_path,
            file_path=system_config.mqtt_config,
            log_mode=self.log_mode,
        ...
        return SystemAssembly(name=system_config.system_name, mqtt=mqtt, instances=instances)
